...
for (let i = 0; i < input.length; i++) {
    for (let j = i; j < input.length; j++) {
        for (let k = i; k < input.length; k++) {
            let thing = productof3(input[i], input[j], input[k]);
            if (thing) {
                document.write(
                    "input: "
                    + thing[0] + "+" 
